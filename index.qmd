...
> You run a test. The variant improves conversion by 0.7% (relative). It’s not statistically significant — so you kill it. What did you just leave on the table — and how many times has that happened before?
...
Traditional significance tests — SPRT and Fixed — were built to detect big, obvious wins. But in these simulations, the average effect is 100. Small gains like 100.3? SPRT shrugs. Fixed tests, tuned to detect 101, never even notice.
...
You're doing Bayesian inference — just with extra steps.
